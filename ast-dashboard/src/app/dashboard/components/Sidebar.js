    ...
    <div className="sidebar" style={{ backgroundColor: "#2160A2" }}>
      ...
      {/* <body class="hold-transition sidebar-mini"> */}
                ...
                >
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      ...
                      <p>
                        ระบบซื้อขาย <i class="right fas fa-angle-left"></i>
                        <i class=""></i>
                      </p>
                    </a>
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="nav-icon fas fa-shopping-cart"></i>
                      <p>
                        วัตถุดิบ <i class="right fas fa-angle-left"></i>
                        <i class=""></i>
                      </p>
                    </a>
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a
                          href="{{ route('materialstore.index') }}"
                          class="nav-link"
                        >
                          <i class="far fa-circle nav-icon"></i>
                      ...
                      <li class="nav-item">
                        <a
                          href="add_withdraw_materials_outside.php"
                          class="nav-link"
                        >
                          <i class="far fa-circle nav-icon"></i>
                      ...
                      <li class="nav-item">
                        <a
                          href="{{ route('materialstore.create') }}"
                          class="nav-link"
                        >
                          <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      ...
                      <p>
                        ผู้ตรวจสอบ<i class="right fas fa-angle-left"></i>
                        <i class=""></i>
                      </p>
                    </a>
                    <ul class="nav nav-treeview">
        ...
        <footer class="main-footer">
          Copyright © 2022 Asia Industrial Textile Co., Ltd. (AIT) All rights
          reserved.
        </footer>
